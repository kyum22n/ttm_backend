...
public class ChatController {
  ...
  public void onSend(ChatSendReq req) {
    ...
    if (!chatRoomService.isMember(roomId, req.getSenderId())) return;
    if (!chatRoomService.isApproved(roomId)) return;
  ...
  public void onRead(ChatReadReq req) {
    if (!chatRoomService.isMember(req.getRoomId(), req.getUserId())) return;
    if (!chatRoomService.isApproved(req.getRoomId())) return;
