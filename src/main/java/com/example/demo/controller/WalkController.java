...
public class WalkController {
    ...
    public ResponseEntity<Map<String, Object>> walkApplyReceiveList(
    ...
    public ResponseEntity<Map<String, Object>> walkApplyRequestList(
    ...
    // 1:1 산책 시작
    @PutMapping("/start")
    public ResponseEntity<Map<String, Object>> walkStart(
            @RequestParam("requestOneId") Integer requestOneId,
            @RequestParam("userId") Integer userId) {
        Map<String, Object> map = new HashMap<>();
        // 멱등 + 동시성 안전
        var startedAt = walkService.startOneOnOne(requestOneId, userId);
        map.put("message", "1:1 산책이 시작되었습니다.");
        map.put("requestOneId", requestOneId);
    ...
    // 1:1 산책 종료
    @PutMapping("/end")
    public ResponseEntity<Map<String, Object>> walkEnd(
            @RequestParam("requestOneId") Integer requestOneId,
            @RequestParam("userId") Integer userId) {
        Map<String, Object> map = new HashMap<>();
        var endedAt = walkService.endOneOnOne(requestOneId, userId);
