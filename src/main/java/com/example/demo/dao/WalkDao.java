...
public interface WalkDao {
  ...
  public List<Walk> selectAllWalkByUserId(@Param("userId") Integer userId);
  // 사용자 아이디로 1:1 산책 신청받은 내역 불러오기
  public List<Walk> selectAllWalkApplyByReceiveUserId(@Param("receiveUserId") Integer receiveUserId);
  // 사용자 아이디로 1:1 산책 신청한 내역 불러오기
  public List<Walk> selectAllWalkApplyByRequestUserId(@Param("requestUserId") Integer requestUserId);
  
  // 1:1 산책 신청
  public int insertWalkApply(Walk walk);

  // 1:1 산책 신청 상태 변경
  public int updateWalkApplyStatus(
